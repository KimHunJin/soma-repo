...
function web3VmProvider () {
  ...
  this.toAscii = function () { return self.web3.utils.toAscii.apply(self.web3, arguments) }
  this.fromAscii = function () { return self.web3.utils.fromAscii.apply(self.web3, arguments) }
  this.fromDecimal = function () { return self.web3.utils.fromDecimal.apply(self.web3, arguments) }
  ...
  this.toBigNumber = function () { return self.web3.utils.toBigNumber.apply(self.web3, arguments) }
